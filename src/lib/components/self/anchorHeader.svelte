<script lang="ts">
	...
	function getHeadingText() {
		...
		const content = headingEl?.querySelector("[data-anchor-text]") as HTMLElement | null;
...
>
	<a
		...
		class="text-accent absolute top-1/2 -left-6 -translate-y-1/2 opacity-0 transition-opacity group-hover:opacity-50 hover:opacity-100 focus-visible:opacity-100"
