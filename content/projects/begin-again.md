...
<figure class="my-8 flex flex-col overflow-hidden rounded-xl border bg-card shadow-sm">
  <img 
    ...
    loading="lazy" 
  />
  <figcaption class="border-t bg-muted/50 p-3 text-center text-sm text-muted-foreground">
...
<figure class="my-8 flex flex-col overflow-hidden rounded-xl border bg-card shadow-sm">
  <a 
    ...
    class="group relative block overflow-hidden bg-white dark:bg-zinc-950"
  >
    <img 
    ...
    <div class="absolute right-4 top-4">
      <Badge variant="secondary" class="opacity-90 shadow-sm backdrop-blur-sm">View Full Vector (7.4 MB)</Badge>
    </div>
  </a>
  <figcaption class="border-t bg-muted/50 p-3 text-center text-sm text-muted-foreground">
...
* **Reduced Overhead:** Consolidating customer acquisition, order processing, and analytics into a single platform eliminated multiple external software subscriptions that'd be needed for similar business processes.
